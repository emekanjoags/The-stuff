...
class UserProfileCreationSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        #I MADE THE REFERRAL CODE TO BE THE USERS USERNAME
        # referral_gen = ReferralTokenGenerator()

        # instance.referral_code = referral_gen.token.lower()
        instance.referral_code = instance.username.lower()
        print('referral code created: ', instance.referral_code)
        ...
        # i commented out the free promo bonus giveaway we did on the first week of launch
    ...
    def validate(self, cleaned_data):
        ...
        if user_details.exists():
            if user_details[0].username:
                raise serializers.ValidationError("Sorry! This account has been blocked, contact support for more info.")
