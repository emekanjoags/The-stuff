    ...
    <div>
        ...
        <div class="card-form card-form-login">
            <div class="alert alert-info">
                ...
                <input  class="form-control mt-6" type="text" placeholder="Account holder's name" v-on:keyup="bankDetail" v-model="info.fullName"><br>
                
            
        </div>
        <br>
        <div class="card-form card-form-login" v-show='check'>
            <h3>Make a Transfer or direct deposit into this account</h3>
            <div >
                <p><b>Account Name:</b> Topsport Technologies</p>
                <p><b>Account Number:</b> 2345871070</p>
